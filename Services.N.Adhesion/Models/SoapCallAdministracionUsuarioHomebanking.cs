...
namespace Services.N.Adhesion.Models.SoapCallAdministracionUsuarioHomebankingResponse
{
    ...
    public partial class Body
    {
        public CrearUsuarioResult CrearUsuarioResult { get; set; }
    }

    public partial class CrearUsuarioResult
    {
        public Services.N.Adhesion.Models.AdministracionUsuarioHomebanking.CrearUsuarioResponse CrearUsuarioResponse { get; set; }
    }
}
